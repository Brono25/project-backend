...
describe('Error Handling', () => {
  test('Invalid token', () => {
    ...
    h.testErrorThrown(h.MSG_UNPIN_URL, 'POST', 403, data, h.invalidToken);
  });
  ...
  test('Invalid message ID', () => {
    ...
    h.testErrorThrown(h.MSG_UNPIN_URL, 'POST', 400, data, token1);
  });
  ...
  test('User is not a member of DM which has the message', () => {
    ...
    h.testErrorThrown(h.MSG_UNPIN_URL, 'POST', 400, data, token0);
  });
  ...
  test('User is a member of channel which has the message but does not have owner permissions', () => {
    ...
    h.testErrorThrown(h.MSG_UNPIN_URL, 'POST', 403, data, token2);
  });
